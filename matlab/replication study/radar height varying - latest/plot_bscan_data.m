...
file_names = ["72cm_soil_97cm_plate_0_bottles_sensorlogic_3_ddc_1_dac_max_1100_dac_min_949" "92cm_soil_117cm_plate_0_bottles_sensorlogic_3_ddc_1_dac_max_1100_dac_min_949" "111cm_soil_136cm_plate_0_bottles_sensorlogic_3_ddc_1_dac_max_1100_dac_min_949"];
...
%     plot(xx.*15, yy, xx(TF).*15, yy(TF), 'r*', x.*15, y, 'go')
    title(extractBefore(file_names(i), 'sensor'));
    xlabel("Range (cm)")
    ylabel("Amplitude")
    xlim([0 200])
    ylim([0 12])
