...
file_names = ["aluminum_plate_99cm_soil_none_3_ddc_1_dac_max_1100_dac_min_949" "aluminum_plate_104cm_soil_94cm_3_ddc_1_dac_max_1100_dac_min_949" "aluminum_plate_104cm_soil_90cm_3_ddc_1_dac_max_1100_dac_min_949" "aluminum_plate_104cm_soil_85cm_3_ddc_1_dac_max_1100_dac_min_949"];
...
%     plot(xx.*15, yy, xx(TF).*15, yy(TF), 'r*', x.*15, y, 'go')
    title(extractBefore(file_names(i), '3_'));
    xlabel("Range (cm)")
    ylabel("Amplitude")
    xlim([0 200])
    ylim([0 12])
